 ...
 * Copy ported verbatim from the dining mockups (v6); the phone, WeChat
 * handle, hours, address, room count, and footprint list are placeholders
 * confirmed before launch. CMS-driven once the separate Sanity project lands.
 */
export const restaurant: Restaurant = {
  ...
  privateDining: {
    ...
    facts: [
      ...
      {
        label: "Booking",
        value: "Separate enquiry channel for private events",
      },
    ],
  },
  story: {
