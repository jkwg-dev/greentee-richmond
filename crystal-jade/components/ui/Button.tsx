...
/**
 * The only button styles in the system. Sharp corners, tracked uppercase
 * label. `solid` and `light` carry ink text; `ghost` is champagne on dark
 * surfaces only. The `sm` size serves the rail and compact placements.
 */
const button = cva(
