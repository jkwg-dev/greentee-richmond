...
export type PhotoFrameProps = {
  /** Placeholder gradient, sampled from the deck renders. */
  tint?: PhotoTint;
  ...
  className?: string;
  /** Overrides the tinted fill, e.g. a `<SiteImage>` once photography lands. */
  children?: React.ReactNode;
};

/**
 * Styled pending state standing in for production imagery. Noir surface,
 * inset vignette, and an irregular fractal-noise grain overlay; every image
 * ships through this until its content field is filled. Decorative, so the
