...
/**
 * Filter / nav chip (menu category filters). The jade accent serves Crystal
 * Jade surfaces; champagne is the neutral default. 44px touch target. Active
 * state never relies on color alone: fill plus weight.
 */
const chip = cva(
