...
/**
 * Shared reveal observers, one per threshold. Each element is observed once,
 * then released.
 */
...
/**
 * Opacity + rise entrance on the `[data-reveal]` system. Polymorphic so it
 * decorates the real element rather than wrapping it in a div. The `in` state
 * lives in React (not an imperative `classList.add`) so it survives
 * re-renders of dynamic parents like the menu filter; reduced motion reveals
 * via the `html.rm [data-reveal]` CSS rule.
 */
